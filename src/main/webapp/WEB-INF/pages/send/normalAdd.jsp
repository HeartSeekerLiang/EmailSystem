...
<div class="container">
    ...
    <form:form action="/send/normal/add" method="post" commandName="normal" role="form" enctype="multipart/form-data">

        <div class="form-group">
            <label for="recv">收件人<small>(请导入用户邮箱Excel文件，必须为xls后缀)</small>：</label>
            <input type="file" id="recv" name="recv" class="form-control">
        </div>

        <div class="form-group">
            <label for="subject">标题：</label>
            <input type="text" class="form-control" id="subject" name="subject" placeholder="标题与正文必须先通过审核">
        </div>
