...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="/emails/update/${email.eid}" type="button" class="btn btn-warning btn-sm">编辑</a>
            <a href="/emails/send/${email.eid}" type="button" class="btn btn-success btn-sm">发送</a>
        </div>
    </div>
</div>
