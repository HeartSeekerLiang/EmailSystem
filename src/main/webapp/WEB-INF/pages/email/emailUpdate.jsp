...
<div class="container">
    ...
    <form:form action="/emails/update" method="post" commandName="email" role="form">
        ...
        <div class="form-group">
            ...
            <script id="content" name="content" type="text/plain"
                    style="width:100%;min-height:500px;" data-content='${email.content}'></script>
        </div>

        <input type="text" class="hidden" id="eid" name="eid" value="${email.eid}">
